...
import com.jwei.mysearch.overlay.BikingRouteOverlay;
import com.jwei.mysearch.overlay.DrivingRouteOverlay;
import com.jwei.mysearch.overlay.OverlayManager;
import com.jwei.mysearch.overlay.TransitRouteOverlay;
import com.jwei.mysearch.overlay.WalkingRouteOverlay;
...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void nodeClick(View v) {
        ...
        popupText.setBackgroundResource(R.mipmap.map1);
    ...
    private class MyDrivingRouteOverlay extends DrivingRouteOverlay {
        ...
        public BitmapDescriptor getStartMarker() {
            if (useDefaultIcon) {
                return BitmapDescriptorFactory.fromResource(R.mipmap.map1);
            }
            return null;
        }
